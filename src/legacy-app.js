...
var I18N={
  ...
  'zh-TW':{
    ...
    temporalReviewTitle:'時間回顧',temporalReviewText:'看清今天要處理、已經逾期和仍在等待的事情，再決定下一步。',reviewToday:'今日',reviewMustHandle:'今天處理',reviewOverdue:'已經逾期',reviewWaiting:'等待他人',reviewTomorrow:'明天',reviewNextAction:'建議下一步',reviewNoPriority:'目前沒有緊迫事項',reviewNoPriorityHint:'新的承諾、逾期或等待事項會出現在這裡。',reviewOpen:'查看',reviewComplete:'完成',reviewLater:'稍後',reviewWeekly:'本週回顧',reviewCompleted:'本週完成',reviewOpenCommitments:'未完成承諾',reviewPostponed:'重複延期',reviewNextWeek:'下週安排',reviewDataTools:'回顧資料',reviewExportDaily:'匯出今日簡報',reviewExportWeekly:'匯出週回顧',reviewExportCorrections:'匯出糾正記錄',reviewClearCorrections:'清除糾正記錄',reviewLocalOnly:'筆本機糾正',reviewLoadLow:'輕負荷',reviewLoadMedium:'中等負荷',reviewLoadHigh:'高負荷',
