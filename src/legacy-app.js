...
var I18N={
  'zh-CN':{
    ...
    temporalReviewTitle:'时间回顾',temporalReviewText:'看清今天要处理、已经逾期和仍在等待的事情，再决定下一步。',reviewToday:'今日',reviewMustHandle:'今天处理',reviewOverdue:'已经逾期',reviewWaiting:'等待他人',reviewTomorrow:'明天',reviewNextAction:'建议下一步',reviewNoPriority:'当前没有紧迫事项',reviewNoPriorityHint:'新的承诺、逾期或等待事项会出现在这里。',reviewOpen:'查看',reviewComplete:'完成',reviewLater:'稍后',reviewWeekly:'本周回顾',reviewCompleted:'本周完成',reviewOpenCommitments:'未完成承诺',reviewPostponed:'重复延期',reviewNextWeek:'下周安排',reviewDataTools:'回顾数据',reviewExportDaily:'导出今日简报',reviewExportWeekly:'导出周回顾',reviewExportCorrections:'导出纠正记录',reviewClearCorrections:'清除纠正记录',reviewLocalOnly:'条本地纠正',reviewLoadLow:'轻负荷',reviewLoadMedium:'中等负荷',reviewLoadHigh:'高负荷',reviewLoadCurrent:'当前负荷',reviewDueAndOverdue:'今天及逾期',reviewOverdueOnly:'其中逾期',reviewLoadBasis:'按今天到期数量判断',reviewNoAutoChanges:'未自动改动任何状态',reviewOverdueNote:'逾期不等于完成',reviewDeLoadTitle:'调整今天的负荷',reviewDeLoadSubtitle:'所有变化都先预览再确认',
  ...
  'zh-TW':{
    ...
    temporalReviewTitle:'時間回顧',temporalReviewText:'看清今天要處理、已經逾期和仍在等待的事情，再決定下一步。',reviewToday:'今日',reviewMustHandle:'今天處理',reviewOverdue:'已經逾期',reviewWaiting:'等待他人',reviewTomorrow:'明天',reviewNextAction:'建議下一步',reviewNoPriority:'目前沒有緊迫事項',reviewNoPriorityHint:'新的承諾、逾期或等待事項會出現在這裡。',reviewOpen:'查看',reviewComplete:'完成',reviewLater:'稍後',reviewWeekly:'本週回顧',reviewCompleted:'本週完成',reviewOpenCommitments:'未完成承諾',reviewPostponed:'重複延期',reviewNextWeek:'下週安排',reviewDataTools:'回顧資料',reviewExportDaily:'匯出今日簡報',reviewExportWeekly:'匯出週回顧',reviewExportCorrections:'匯出糾正記錄',reviewClearCorrections:'清除糾正記錄',reviewLocalOnly:'筆本機糾正',reviewLoadLow:'輕負荷',reviewLoadMedium:'中等負荷',reviewLoadHigh:'高負荷',reviewLoadCurrent:'目前負荷',reviewDueAndOverdue:'今天及逾期',reviewOverdueOnly:'其中逾期',reviewLoadBasis:'按今天到期數量判斷',reviewNoAutoChanges:'未自動改動任何狀態',reviewOverdueNote:'逾期不等於完成',reviewDeLoadTitle:'調整今天的負荷',reviewDeLoadSubtitle:'所有變更都先預覽再確認',
  ...
  'en':{
    ...
    temporalReviewTitle:'Time review',temporalReviewText:'See what needs attention today, what is overdue, and what still depends on someone else.',reviewToday:'Today',reviewMustHandle:'Due today',reviewOverdue:'Overdue',reviewWaiting:'Waiting',reviewTomorrow:'Tomorrow',reviewNextAction:'Suggested next step',reviewNoPriority:'Nothing urgent right now',reviewNoPriorityHint:'New commitments, overdue items, and waiting items will appear here.',reviewOpen:'Open',reviewComplete:'Complete',reviewLater:'Later',reviewWeekly:'Weekly review',reviewCompleted:'Completed',reviewOpenCommitments:'Open promises',reviewPostponed:'Postponed again',reviewNextWeek:'Next week',reviewDataTools:'Review data',reviewExportDaily:'Export daily brief',reviewExportWeekly:'Export weekly review',reviewExportCorrections:'Export corrections',reviewClearCorrections:'Clear corrections',reviewLocalOnly:'local corrections',reviewLoadLow:'Light load',reviewLoadMedium:'Moderate load',reviewLoadHigh:'Heavy load',reviewLoadCurrent:'Current load',reviewDueAndOverdue:'Due today or overdue',reviewOverdueOnly:'Overdue',reviewLoadBasis:'Based on items due today',reviewNoAutoChanges:'No status changed automatically',reviewOverdueNote:'Overdue does not mean complete',reviewDeLoadTitle:'Adjust today’s load',reviewDeLoadSubtitle:'Preview every change before confirming',
  ...
  'ja':{
    ...
    temporalReviewTitle:'時間レビュー',temporalReviewText:'今日対応すること、期限超過、相手待ちを確認して次の一歩を決めます。',reviewToday:'今日',reviewMustHandle:'今日対応',reviewOverdue:'期限超過',reviewWaiting:'相手待ち',reviewTomorrow:'明日',reviewNextAction:'次のおすすめ',reviewNoPriority:'緊急の項目はありません',reviewNoPriorityHint:'新しい約束、期限超過、相手待ちはここに表示されます。',reviewOpen:'開く',reviewComplete:'完了',reviewLater:'あとで',reviewWeekly:'週次レビュー',reviewCompleted:'今週完了',reviewOpenCommitments:'未完了の約束',reviewPostponed:'再延期',reviewNextWeek:'来週',reviewDataTools:'レビューデータ',reviewExportDaily:'今日の概要を書き出す',reviewExportWeekly:'週次レビューを書き出す',reviewExportCorrections:'修正履歴を書き出す',reviewClearCorrections:'修正履歴を消去',reviewLocalOnly:'件のローカル修正',reviewLoadLow:'軽い負荷',reviewLoadMedium:'中程度の負荷',reviewLoadHigh:'高い負荷',reviewLoadCurrent:'現在の負荷',reviewDueAndOverdue:'今日まで・期限超過',reviewOverdueOnly:'期限超過',reviewLoadBasis:'今日が期限の件数で判定',reviewNoAutoChanges:'状態は自動変更されません',reviewOverdueNote:'期限超過は完了を意味しません',reviewDeLoadTitle:'今日の負荷を調整',reviewDeLoadSubtitle:'すべての変更を確認前にプレビュー',
...
function renderReviewPage(){
  ...
  if(summary&&window.ShikeDeLoad){
    ...
    var loadKey=model.band==='HIGH'?'reviewLoadHigh':model.band==='MEDIUM'?'reviewLoadMedium':'reviewLoadLow';
    summary.innerHTML='<div><span>'+escHtml(t('reviewLoadCurrent'))+'</span><strong>'+escHtml(t(loadKey))+'</strong><small>'+escHtml(t('reviewLoadBasis'))+'</small></div>'+
      '<div><span>'+escHtml(t('reviewDueAndOverdue'))+'</span><strong>'+model.count+'</strong><small>'+escHtml(t('reviewNoAutoChanges'))+'</small></div>'+
      '<div><span>'+escHtml(t('reviewOverdueOnly'))+'</span><strong>'+model.overdue+'</strong><small>'+escHtml(t('reviewOverdueNote'))+'</small></div>';
  }
