// v2.2.0-alpha3.1 Sync UI Honesty Test
...
(function(){
  ...
  assert(version.includes("v2.2.0-alpha3.1"), 'version shows rc5.1');

  // 3. Cache is rc52
  assert(sw.includes("shike-v220alpha31-v64"), 'cache name is rc52');
