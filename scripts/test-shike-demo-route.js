...
add('route entry and version are present', () => {
  ...
  assert(script.includes("var APP_VERSION='v2.0.0-rc2'"), 'APP_VERSION should be v2.0.0-rc2');
  assert(sw.includes("shike-v200rc2-v56"), 'service worker cache should be v150');
});
