...
add('route entry and version are present', () => {
  ...
  assert(script.includes("var APP_VERSION='v2.0.0-rc3'"), 'APP_VERSION should be v2.0.0-rc3');
  assert(sw.includes("shike-v200rc3-v57"), 'service worker cache should be v150');
});
