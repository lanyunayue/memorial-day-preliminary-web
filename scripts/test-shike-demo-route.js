...
add('route entry and version are present', () => {
  ...
  assert(script.includes("var APP_VERSION='v2.0.0-rc4'"), 'APP_VERSION should be v2.0.0-rc4');
  assert(sw.includes("shike-v200rc4-v58"), 'service worker cache should be v150');
});
