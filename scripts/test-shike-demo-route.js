...
add('route entry and version are present', () => {
  ...
  assert(script.includes("var APP_VERSION='v2.0.0-rc1'"), 'APP_VERSION should be v2.0.0-rc1');
  assert(sw.includes("shike-v200rc1-v55"), 'service worker cache should be v150');
});
