...
add('route entry and version are present', () => {
  ...
  assert(script.includes("var APP_VERSION='v1.0.0-rc'"), 'APP_VERSION should be v1.0.0-rc');
  assert(sw.includes("shike-v100rc-v45"), 'service worker cache should be v097');
});
