...
async function main() {
  ...
  await client.evaluate(`
    ...
    localStorage.setItem('shike_seen_release_note_version', 'v0.9.8');
  `);
  await client.navigate(APP_URL);
  ...
  add('app loads v0.9.8 route shell', version.appVersion === 'v0.9.8' && version.cacheFetch === 'function' && version.route, JSON.stringify(version));
