...
add('42. APP_VERSION = v2.0.0-rc2', () => {
  assert(fs.readFileSync(path.join(root,'src/config/version.js'),'utf8').includes("v2.0.0-rc2"), 'APP_VERSION should be v2.0.0-rc2');
});
add('43. cache name shike-v200rc2-v56', () => {
  assert(fs.readFileSync(path.join(root,'sw.js'),'utf8').includes('shike-v200rc2-v56'), 'CACHE_NAME should be shike-v200rc2-v56');
});
