...
add('43. cache name shike-v220alpha3-v64', () => {
  assert(fs.readFileSync(path.join(root,'sw.js'),'utf8').includes('shike-v220alpha3-v64'), 'CACHE_NAME should be shike-v220alpha3-v64');
});
