...
add('42. APP_VERSION = v1.4.1', () => {
  assert(fs.readFileSync(path.join(root,'src/config/version.js'),'utf8').includes("v1.4.1"), 'APP_VERSION should be v1.4.1');
});
add('43. cache name shike-v141-v53', () => {
  assert(fs.readFileSync(path.join(root,'sw.js'),'utf8').includes('shike-v141-v53'), 'CACHE_NAME should be shike-v141-v53');
});
