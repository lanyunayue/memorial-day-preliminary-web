...
add('43. cache name shike-v220alpha4-v65', () => {
  assert(fs.readFileSync(path.join(root,'sw.js'),'utf8').includes('shike-v220alpha4-v65'), 'CACHE_NAME should be shike-v220alpha4-v65');
});
