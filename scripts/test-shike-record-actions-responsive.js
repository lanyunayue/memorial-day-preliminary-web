...
add('42. APP_VERSION = v2.3.0-alpha2-webfix', () => {
  assert(fs.readFileSync(path.join(root,'src/config/version.js'),'utf8').includes("v2.3.0-alpha2-webfix"), 'APP_VERSION should be v2.3.0-alpha2-webfix');
});
add('43. cache name shike-v230a2-webfix-v65', () => {
  assert(fs.readFileSync(path.join(root,'sw.js'),'utf8').includes('shike-v230a2-webfix-v65'), 'CACHE_NAME should be shike-v230a2-webfix-v65');
});
