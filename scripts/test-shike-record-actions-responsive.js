...
add('42. APP_VERSION = v2.2.0-alpha3.1', () => {
  assert(fs.readFileSync(path.join(root,'src/config/version.js'),'utf8').includes("v2.2.0-alpha3.1"), 'APP_VERSION should be v2.2.0-alpha3.1');
});
add('43. cache name shike-v220alpha31-v64', () => {
  assert(fs.readFileSync(path.join(root,'sw.js'),'utf8').includes('shike-v220alpha31-v64'), 'CACHE_NAME should be shike-v220alpha31-v64');
});
