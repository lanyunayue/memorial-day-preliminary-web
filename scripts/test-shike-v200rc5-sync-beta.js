/**
 * v2.2.0-alpha3 Optional Sync Beta Release Candidate Tests
 */
const fs = require('fs');
...
console.log('=== v2.2.0-alpha3 Optional Sync Beta Tests ===\n');
...
assert(ver && ver.includes('v2.2.0-alpha3'), 'APP_VERSION is v2.2.0-alpha3');
...
console.log('\n========================================');
console.log('v2.2.0-alpha3 Optional Sync Beta tests: ' + passed + '/' + (passed+failed) + ' passed');
