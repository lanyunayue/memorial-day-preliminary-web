/**
 * v2.0.0-rc5.2 Optional Sync Beta Release Candidate Tests
 */
const fs = require('fs');
...
console.log('=== v2.0.0-rc5.2 Optional Sync Beta Tests ===\n');
...
assert(ver && ver.includes('v2.0.0-rc5.2'), 'APP_VERSION is v2.0.0-rc5.2');
...
console.log('\n========================================');
console.log('v2.0.0-rc5.2 Optional Sync Beta tests: ' + passed + '/' + (passed+failed) + ' passed');
