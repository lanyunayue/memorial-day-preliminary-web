...
add('version and service worker cache are ready for v2.2.0-alpha3.1 candidate', () => {
  ...
  assert(sw.includes("CACHE_NAME = 'shike-v220alpha31-v64'"), 'service worker cache should be v150');
});
