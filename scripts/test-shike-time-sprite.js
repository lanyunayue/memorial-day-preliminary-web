...
add('version and service worker cache are ready for v2.3.0-alpha2-webfix candidate', () => {
  ...
  assert(sw.includes("CACHE_NAME = 'shike-v230a2-webfix-v68'"), 'service worker cache should be v230a2-webfix');
});
