...
add('version and service worker cache are ready for v2.0.0-rc3 candidate', () => {
  ...
  assert(sw.includes("CACHE_NAME = 'shike-v200rc3-v57'"), 'service worker cache should be v150');
});
