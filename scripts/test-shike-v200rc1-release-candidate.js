/**
 * v2.0.0-rc1 Release Candidate Test Suite
...
console.log('=== v2.0.0-rc1 Release Candidate Tests ===\n');

// 1. Version and cache
console.log('[1] Version and cache');
const vjs = readSafe(path.join(V, 'src/config/version.js'));
assert(vjs && vjs.includes('v2.0.0-rc1'), 'APP_VERSION is v2.0.0-rc1');
const sw = readSafe(path.join(V, 'sw.js'));
assert(sw && sw.includes('shike-v200rc1-v55'), 'CACHE_NAME is shike-v200rc1-v55');
...
assert(html && html.includes('v2.0.0-rc1'), 'v2.0.0-rc1 referenced in HTML');
...
// 14. Release center has v2.0.0-rc1
console.log('\n[14] Release center');
...
// Summary
console.log('\n========================================');
console.log('v2.0.0-rc1 release candidate tests: ' + passed + '/' + (passed+failed) + ' passed');
if (failed > 0) {
