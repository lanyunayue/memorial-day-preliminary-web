/**
 * v2.0.0-rc4 Release Candidate Test Suite
...
console.log('=== v2.0.0-rc4 Release Candidate Tests ===\n');
...
assert(html && html.includes('v2.0.0-rc4'), 'v2.0.0-rc4 referenced in HTML');
...
// 14. Release center has v2.0.0-rc4
console.log('\n[14] Release center');
...
// Summary
console.log('\n========================================');
console.log('v2.0.0-rc4 release candidate tests: ' + passed + '/' + (passed+failed) + ' passed');
if (failed > 0) {
