/**
 * v2.0.0-rc3 Release Candidate Test Suite
...
console.log('=== v2.0.0-rc3 Release Candidate Tests ===\n');

// 1. Version and cache
console.log('[1] Version and cache');
const vjs = readSafe(path.join(V, 'src/config/version.js'));
assert(vjs && vjs.includes('v2.0.0-rc3'), 'APP_VERSION is v2.0.0-rc3');
const sw = readSafe(path.join(V, 'sw.js'));
assert(sw && sw.includes('shike-v200rc3-v57'), 'CACHE_NAME is shike-v200rc3-v57');
...
assert(html && html.includes('v2.0.0-rc3'), 'v2.0.0-rc3 referenced in HTML');
...
// 14. Release center has v2.0.0-rc3
console.log('\n[14] Release center');
...
// Summary
console.log('\n========================================');
console.log('v2.0.0-rc3 release candidate tests: ' + passed + '/' + (passed+failed) + ' passed');
if (failed > 0) {
