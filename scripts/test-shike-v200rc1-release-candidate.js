/**
 * v2.2.0-alpha3 Release Candidate Test Suite
...
console.log('=== v2.2.0-alpha3 Release Candidate Tests ===\n');
...
assert((html && html.includes('v2.2.0-alpha3')) || (verJs && verJs.includes('v2.2.0-alpha3')), 'v2.2.0-alpha3 referenced');
...
// 14. Release center has v2.2.0-alpha3
console.log('\n[14] Release center');
...
// Summary
console.log('\n========================================');
console.log('v2.2.0-alpha3 release candidate tests: ' + passed + '/' + (passed+failed) + ' passed');
if (failed > 0) {
