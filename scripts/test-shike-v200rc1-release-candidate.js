/**
 * v2.3.0-alpha2-webfix Release Candidate Test Suite
...
console.log('=== v2.3.0-alpha2-webfix Release Candidate Tests ===\n');

// 1. Version and cache
console.log('[1] Version and cache');
const vjs = readSafe(path.join(V, 'src/config/version.js'));
assert(vjs && vjs.includes('v2.3.0-alpha2-webfix'), 'APP_VERSION is v2.3.0-alpha2-webfix');
...
assert((html && html.includes('v2.3.0-alpha2-webfix')) || (verJs && verJs.includes('v2.3.0-alpha2-webfix')), 'v2.3.0-alpha2-webfix referenced');
...
// 14. Release center has v2.3.0-alpha2-webfix
console.log('\n[14] Release center');
...
// Summary
console.log('\n========================================');
console.log('v2.3.0-alpha2-webfix release candidate tests: ' + passed + '/' + (passed+failed) + ' passed');
if (failed > 0) {
