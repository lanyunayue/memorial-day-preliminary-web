/**
 * v2.0.0-rc3 Product Rescue Release Candidate Tests
 */
const fs = require('fs');
...
console.log('=== v2.0.0-rc3 Product Rescue Tests ===\n');
...
console.log('\n========================================');
console.log('v2.0.0-rc3 Product Rescue tests: ' + passed + '/' + (passed+failed) + ' passed');
