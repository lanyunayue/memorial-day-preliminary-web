/**
 * v2.0.0-rc4 Reminder Reliability Release Candidate Tests
 */
const fs = require('fs');
...
console.log('=== v2.0.0-rc4 Reminder Reliability Tests ===\n');
...
console.log('\n========================================');
console.log('v2.0.0-rc4 Reminder Reliability tests: ' + passed + '/' + (passed+failed) + ' passed');
