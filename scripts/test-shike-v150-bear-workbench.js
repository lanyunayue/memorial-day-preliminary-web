...
add('version v2.3.0-alpha2-webfix',read('src/config/version.js').includes("APP_VERSION='v2.3.0-alpha2-webfix'"));
add('cache v62',sw.includes("CACHE_NAME = 'shike-v230a2-webfix-v65'"));
