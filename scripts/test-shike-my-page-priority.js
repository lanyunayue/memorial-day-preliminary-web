...
add('APP_VERSION = v1.5.0', () => { assert(script.includes("APP_VERSION='v1.5.0'"),'APP_VERSION not v1.5.0'); });
add('SW cache = shike-v150-v54', () => { assert(sw.includes('shike-v150-v54'),'cache not v150'); assert(!sw.includes('shike-v141-v53'),'old cache still present'); });
