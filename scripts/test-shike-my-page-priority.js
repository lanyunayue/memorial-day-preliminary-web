...
add('APP_VERSION = v2.0.0-rc2', () => { assert(script.includes("APP_VERSION='v2.0.0-rc2'"),'APP_VERSION not v2.0.0-rc2'); });
add('SW cache = shike-v200rc2-v56', () => { assert(sw.includes('shike-v200rc2-v56'),'cache not v150'); assert(!sw.includes('shike-v141-v53'),'old cache still present'); });
