...
add('APP_VERSION = v2.3.0-alpha2-webfix', () => { assert(script.includes("APP_VERSION='v2.3.0-alpha2-webfix'"),'APP_VERSION not v2.3.0-alpha2-webfix'); });
add('SW cache = shike-v230a2-webfix-v65', () => { assert(sw.includes('shike-v230a2-webfix-v65'),'cache not v62'); assert(!sw.includes('shike-v141-v53'),'old cache still present'); });
