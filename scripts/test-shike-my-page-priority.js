...
add('APP_VERSION = v2.0.0-rc4', () => { assert(script.includes("APP_VERSION='v2.0.0-rc4'"),'APP_VERSION not v2.0.0-rc4'); });
add('SW cache = shike-v200rc4-v58', () => { assert(sw.includes('shike-v200rc4-v58'),'cache not v150'); assert(!sw.includes('shike-v141-v53'),'old cache still present'); });
