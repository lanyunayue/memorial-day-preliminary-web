...
add('APP_VERSION = v2.0.0-rc3', () => { assert(script.includes("APP_VERSION='v2.0.0-rc3'"),'APP_VERSION not v2.0.0-rc3'); });
add('SW cache = shike-v200rc3-v57', () => { assert(sw.includes('shike-v200rc3-v57'),'cache not v150'); assert(!sw.includes('shike-v141-v53'),'old cache still present'); });
