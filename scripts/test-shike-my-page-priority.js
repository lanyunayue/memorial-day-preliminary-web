...
const root = 'E:\\lifetime-web-v094-my-page-priority';
...
add('APP_VERSION = v0.9.4', () => { assert(html.includes("APP_VERSION='v0.9.4'"),'APP_VERSION not v0.9.4'); });
add('SW cache = shike-v094-v40', () => { assert(sw.includes('shike-v094-v40'),'cache not v094'); assert(!sw.includes('shike-v093-v39'),'old cache v093 still present'); });
