...
add('APP_VERSION = v1.2.0', () => { assert(script.includes("APP_VERSION='v1.2.0'"),'APP_VERSION not v1.2.0'); });
add('SW cache = shike-v120-v48', () => { assert(sw.includes('shike-v120-v48'),'cache not v097'); assert(!sw.includes('shike-v096-v42'),'old cache v096 still present'); });
