...
add('APP_VERSION = v1.4.1', () => { assert(script.includes("APP_VERSION='v1.4.1'"),'APP_VERSION not v1.4.1'); });
add('SW cache = shike-v141-v53', () => { assert(sw.includes('shike-v141-v53'),'cache not v132'); assert(!sw.includes('shike-v131-v50'),'old cache v096 still present'); });
