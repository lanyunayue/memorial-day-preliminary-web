...
add('APP_VERSION = v2.0.0-rc1', () => { assert(script.includes("APP_VERSION='v2.0.0-rc1'"),'APP_VERSION not v2.0.0-rc1'); });
add('SW cache = shike-v200rc1-v55', () => { assert(sw.includes('shike-v200rc1-v55'),'cache not v150'); assert(!sw.includes('shike-v141-v53'),'old cache still present'); });
