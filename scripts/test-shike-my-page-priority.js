...
add('APP_VERSION = v1.3.2', () => { assert(script.includes("APP_VERSION='v1.3.2'"),'APP_VERSION not v1.3.2'); });
add('SW cache = shike-v132-v51', () => { assert(sw.includes('shike-v132-v51'),'cache not v132'); assert(!sw.includes('shike-v131-v50'),'old cache v096 still present'); });
