...
add('APP_VERSION = v2.0.0-rc5', () => { assert(script.includes("APP_VERSION='v2.0.0-rc5'"),'APP_VERSION not v2.0.0-rc5'); });
add('SW cache = shike-v200rc5-v59', () => { assert(sw.includes('shike-v200rc5-v59'),'cache not v150'); assert(!sw.includes('shike-v141-v53'),'old cache still present'); });
