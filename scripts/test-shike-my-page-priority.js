...
add('APP_VERSION = v1.3.0', () => { assert(script.includes("APP_VERSION='v1.3.0'"),'APP_VERSION not v1.3.0'); });
add('SW cache = shike-v130-v49', () => { assert(sw.includes('shike-v130-v49'),'cache not v097'); assert(!sw.includes('shike-v096-v42'),'old cache v096 still present'); });
