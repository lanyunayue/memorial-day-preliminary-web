/**
 * v2.2.0-alpha3 Information Architecture Tests
 */
const fs = require('fs');
...
assert((html && html.includes('v2.2.0-alpha3')) || (versionJs && versionJs.includes('v2.2.0-alpha3')), 'v2.2.0-alpha3 referenced');
